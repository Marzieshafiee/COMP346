...
//method level synchronizing for 10 depositor & 20 withdrawer
...
public class AccountManager {
	public static void main(String[] args) {
		...
		//change the withdrawer to 20
		Withdrawer [] withdraw = new Withdrawer[20];
		...
		//change, add 10 more withdrawers
		withdraw[10] = new Withdrawer(account[0]);
		withdraw[11] = new Withdrawer(account[1]);
		withdraw[12] = new Withdrawer(account[2]);
		withdraw[13] = new Withdrawer(account[3]);
		withdraw[14] = new Withdrawer(account[4]);
		withdraw[15] = new Withdrawer(account[5]);
		withdraw[16] = new Withdrawer(account[6]);
		withdraw[17] = new Withdrawer(account[7]);
		withdraw[18] = new Withdrawer(account[8]);
		withdraw[19] = new Withdrawer(account[9]);
